...
import com.lobakkang.keymapper.wrappers.ContentProvider;
    ...
    public void putValue(String table, String key, String value) throws SettingsException {
        if (Build.VERSION.SDK_INT <= Build.VERSION_CODES.R) {
            ...
            try (ContentProvider provider = serviceManager.getActivityManager().createSettingsProvider()) {
                ...
                logger.w("Could not put settings value via ContentProvider, fallback to settings process", e);
            }
        }
    ...
    public String getAndPutValue(String table, String key, String value) throws SettingsException {
        if (Build.VERSION.SDK_INT <= Build.VERSION_CODES.R) {
            ...
            try (ContentProvider provider = serviceManager.getActivityManager().createSettingsProvider()) {
                ...
                logger.w("Could not get and put settings value via ContentProvider, fallback to settings process", e);
            }
        }
